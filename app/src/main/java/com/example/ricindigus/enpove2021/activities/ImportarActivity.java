...
public class ImportarActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener,
                                ...
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int id) {
                                     ...
                                     /* data.eliminarTabla(SQLConstantes.tablacaratula);
                                        ...
                                        data.eliminarTablenivelhogar(SQLConstantes.tablahogares,idVivienda);
                                        data.eliminarTablenivelhogar(SQLConstantes.tablavisitasencuestador,idVivienda);
                                        data.eliminarTablenivelhogar(SQLConstantes.tablavisitassupervisor,idVivienda);
                                        data.eliminarTablenivelhogar(SQLConstantes.tablaresultadoencuestador,idVivienda);
                                        data.eliminarTablenivelhogar(SQLConstantes.tablaresultadosupervisor,idVivienda);
                                        data.eliminarTablenivelhogar(SQLConstantes.tablaresultadoresidente,idVivienda);
                                        data.eliminarTable(SQLConstantes.tablafuncionarios,idVivienda);
                                        data.eliminarTablenivelhogar(SQLConstantes.tablamodulo1h,idVivienda);
                                        data.eliminarTable(SQLConstantes.tablamodulo1v,idVivienda);
                                        data.eliminarTablenivelhogar(SQLConstantes.tablaresidentes,idVivienda);
                                        data.eliminarTablenivelhogar(SQLConstantes.tablamodulo3,idVivienda);
                                        data.eliminarTablenivelhogar(SQLConstantes.tablam3p309rutas,idVivienda);
                                        data.eliminarTablenivelhogar(SQLConstantes.tablam3p318personas,idVivienda);
                                        data.eliminarTablenivelhogar(SQLConstantes.tablamodulo4,idVivienda);
                                        data.eliminarTablenivelhogar(SQLConstantes.tablamodulo5,idVivienda);
                                        data.eliminarTablenivelhogar(SQLConstantes.tablamodulo6,idVivienda);
                                        data.eliminarTablenivelhogar(SQLConstantes.tablamodulo7,idVivienda);
                                        data.eliminarTablenivelhogar(SQLConstantes.tablamodulo8,idVivienda);
                                        data.eliminarTable(SQLConstantes.tablafragmentsvivienda,idVivienda);
                                        data.eliminarTablenivelhogar(SQLConstantes.tablafragmentshogar,idVivienda);
                                        data.eliminarTablenivelhogar(SQLConstantes.tablafragments,idVivienda);
                                        data.eliminarTablenivelhogar(SQLConstantes.tablalayouts,idVivienda);
                                        data.eliminarTablenivelhogar(SQLConstantes.tablacoberturafragments,idVivienda);
                                        data.close();
                                        ////////////////////////////////////////////
    ...
    public void agregarVariableModulo1H(String campo, String valor){
        if (valor != null){
            switch (campo){
                ...
                case SQLConstantes.modulo1_h_c1_p108_1_o:currentModulo1H.setC1_p108_1_o(valor);break;
                case SQLConstantes.modulo1_h_c1_p108_2:currentModulo1H.setC1_p108_2(valor);break;
                case SQLConstantes.modulo1_h_c1_p108_2_o:currentModulo1H.setC1_p108_2_o(valor);break;
                case SQLConstantes.modulo1_h_c1_p108_3:currentModulo1H.setC1_p108_3(valor);break;
                case SQLConstantes.modulo1_h_c1_p108_3_o:currentModulo1H.setC1_p108_3_o(valor);break;
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        try {
                            ...
                            status.startResolutionForResult(ImportarActivity.this, PETICION_CONFIG_UBICACION);
        ...
        myRunnable = new Runnable() {
            ...
            public void run() {
                ...
                try{
                    ...
                    if (ActivityCompat.checkSelfPermission(ImportarActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                        ActivityCompat.requestPermissions(ImportarActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, PETICION_PERMISO_LOCALIZACION);
                    }
                    ...
                    ubicacion.setUsuario(DAOUtils.getUsuarioId(idUsuario,ImportarActivity.this).getNombre());
                    ubicacion.setDni(DAOUtils.getUsuarioId(idUsuario,ImportarActivity.this).getDni());
                    ubicacion.setCargo(DAOUtils.getUsuarioId(idUsuario,ImportarActivity.this).getUsuario());
                    ...
                    ubicacion.setVersionApk(UtilsMethods.getVersion(ImportarActivity.this));
                   ...
                   // Toast.makeText(ImportarActivity.this, "LONGITUD ES"+ubicacion.getLongitud() +"\n LATITUD ES"+ubicacion.getLatitud(), Toast.LENGTH_LONG).show();
