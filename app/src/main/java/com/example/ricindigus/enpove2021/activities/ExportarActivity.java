...
public class ExportarActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener,
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        try {
                            ...
                            status.startResolutionForResult(ExportarActivity.this, PETICION_CONFIG_UBICACION);
        ...
        myRunnable = new Runnable() {
            ...
            public void run() {
                ...
                try{
                    ...
                    if (ActivityCompat.checkSelfPermission(ExportarActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                        ActivityCompat.requestPermissions(ExportarActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, PETICION_PERMISO_LOCALIZACION);
                    }
                    ...
                    ubicacion.setUsuario(DAOUtils.getUsuarioId(idUsuario,ExportarActivity.this).getNombre());
                    ubicacion.setDni(DAOUtils.getUsuarioId(idUsuario,ExportarActivity.this).getDni());
                    ubicacion.setCargo(DAOUtils.getUsuarioId(idUsuario,ExportarActivity.this).getUsuario());
                    ...
                    ubicacion.setVersionApk(UtilsMethods.getVersion(ExportarActivity.this));
               ...
               //     Toast.makeText(ExportarActivity.this, "LONGITUD ES"+ubicacion.getLongitud() +"\n LATITUD ES"+ubicacion.getLatitud(), Toast.LENGTH_LONG).show();
